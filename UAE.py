...
if password == 'MsBa%%42%%':
    ...
    display=st.sidebar.radio('Please One of the below pages:',
                                ('Info Page','Analysis of Health Care System in UAE'))


    #start adding to the info page.
    if display == 'Info Page':
    ...
    elif display == 'Analysis of Health Care System in UAE':

        button=st.sidebar.radio('Select which Analysis Date you want to See:',
                                ('Dates Between 2002 and 2008 Pages', 'Dates Between 2011 and 2018 Pages'))



        #start adding analysis to to the Dates Between 2002 nd 2008 page
        if button == 'Dates Between 2002 and 2008 Pages':
